...
const sizeMap = {
  sm: { btn: "h-9 w-9", icon: "h-4 w-4", text: "text-xs gap-2 px-4 py-2" },
  md: { btn: "h-11 w-11", icon: "h-5 w-5", text: "text-sm gap-2.5 px-5 py-2.5" },
  lg: { btn: "h-12 w-12", icon: "h-5 w-5", text: "text-sm gap-3 px-6 py-3" },
};
